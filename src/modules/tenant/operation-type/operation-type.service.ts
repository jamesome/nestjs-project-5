...
export class OperationTypeService {
  ...
  async create(createOperationTypeDto: CreateOperationTypeDto) {
    // const existOperationType = await this.operationTypeRepository.exists({
    //   where: {
    //     category: createOperationTypeDto.category,
    //     name: createOperationTypeDto.name,
    //   },
    // });
  ...
  async update(id: number, updateOperationTypeDto: UpdateOperationTypeDto) {
    return await this.operationTypeRepository.update(
      id,
  ...
  async remove(id: number) {
    return await this.operationTypeRepository.delete(id);
  }
}
